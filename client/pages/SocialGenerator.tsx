          ...
          <div className="lg:col-span-2">
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                {/* Industry Select - match style to Platform Select */}
                <div className="space-y-2">
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-blue-500 to-purple-500 hover:opacity-90 text-white text-lg font-semibold"
                  size="lg"
                >
                  {isGenerating ? (
                    <>
          ...
          <div className="lg:col-span-3 flex items-stretch">
            <Card className="w-full flex flex-col h-full relative">
              ...
              <CardContent className="flex-1 lg:h-[420px] flex flex-col justify-between overflow-hidden">
                {!isGenerating && generatedContent.socialPost ? (
